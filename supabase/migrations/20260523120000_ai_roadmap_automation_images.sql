-- Screenshots / reference images for roadmap automations (detail panel uploads)
...
create policy "ai_roadmap_automations_portal_update"
  on storage.objects for update
  to anon, authenticated
  using (bucket_id = 'ai-roadmap-automations');

drop policy if exists "ai_roadmap_automations_portal_delete" on storage.objects;
create policy "ai_roadmap_automations_portal_delete"
